      ...
      <div className="grid-container">
        <div className='participates__wrapper'>
          ...
          <div className="grid-x align-justify">
            <div className="participates__item cell medium-24 grid-x align-middle align-spaced">
              <div className="cell image small-6">
                <div className='grid-x align-middle'>
                  <img src='./images/network_tokens.png' alt="network_tokens" />
                </div>
              </div>
              <div className='grid-y align-top small-15'>
