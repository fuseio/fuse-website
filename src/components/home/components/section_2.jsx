  ...
  return (
    <section className='studio__wrapper grid-x align-center'>
      <div className="studio">
        <h1 className="studio__title">Customize your own wallet and currency</h1>
        <div className="studio__text">The Fuse Studio allows you to build your own wallet and mint your own custom branded
