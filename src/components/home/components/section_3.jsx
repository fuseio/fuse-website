          ...
          <div className="items grid-x align-justify cell grid-margin-x">
            <div className="item cell medium-24 large-8">
              ...
              <div className="item__content">
                <div className="item__title">Create a community</div>
                <div className="item__text">With the Fuse Studio you can customize your own economy, where you set the
                  rules, decide the look and integrate a wide array of different features.</div>
              </div>
            </div>
            <div className="item cell medium-24 large-8">
              <img alt="currency" className="item__image item__image--step2" src={step2} />
              <div className="item__content">
                <div className="item__title">Choose your currency</div>
                <div className="item__text">Fuse supports any ERC-20 token on Ethereum. You can choose your favorite
                  stablecoin like DAI or decide to mint your own.</div>
              </div>
            </div>
            <div className="item cell medium-24 large-8">
              <img alt="customers" className="item__image item__image--step3" src="./images/step_3.png" />
              <div className="item__content">
                <div className="item__title">Grow your community</div>
                <div className="item__text">Begin inviting your community to your newly built ecosystem by sending them a
                  special invite link.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section_E__wrapper grid-x align-center">
        <div className="section_E grid-x align-center  align-middle">
          <div className="section_E__content grid-y align-left  align-center large-12 cell medium-24">
            <div className="section_E__title">Introducing the Fuse wallet</div>
            <div className="sub-title">All community members can download their own Fuse wallet, where they can store a wide
            array of different currencies and tokens both crypto and traditional fiat currencies. Allowing them to
              participate in this digital economy with ease.</div>
